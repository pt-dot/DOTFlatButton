...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of DOTFlatButton.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/DOTFlatButton'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'balitax' => 'cahyo.mamen@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/DOTFlatButton.git', :tag => s.version.to_s }
